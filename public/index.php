...
Router::add("GET", "/admin/members", AdministratorController::class, "members");
Router::add("GET", "/admin/transaksi", AdministratorController::class, "transaksi");
Router::add("GET", "/admin/cars", AdministratorController::class, "cars");
Router::add("GET", "/admin/admin", AdminController::class, "admin");

Router::add("POST", "/admin/admin", AdminController::class, "postAdmin");
